...
var wrapCollection = function wrapCollection(fn) {
  return function (http, data) {
    ...
    var collectionData = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data)); // @ts-ignore
...
/* harmony import */ var _plain_plain_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plain/plain-client */ "./plain/plain-client.ts");
/* harmony import */ var _plain_as_iterator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./plain/as-iterator */ "./plain/as-iterator.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "asIterator", function() { return _plain_as_iterator__WEBPACK_IMPORTED_MODULE_3__["asIterator"]; });

/* harmony import */ var _plain_checks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./plain/checks */ "./plain/checks.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isDraft", function() { return _plain_checks__WEBPACK_IMPORTED_MODULE_4__["isDraft"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isPublished", function() { return _plain_checks__WEBPACK_IMPORTED_MODULE_4__["isPublished"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isUpdated", function() { return _plain_checks__WEBPACK_IMPORTED_MODULE_4__["isUpdated"]; });
...
function createClient(params) {
  ...
  if (opts.type === 'plain') {
    client = Object(_plain_plain_client__WEBPACK_IMPORTED_MODULE_2__["createPlainClient"])(params, opts.defaults);
  } else {
    var http = Object(_create_cma_http_client__WEBPACK_IMPORTED_MODULE_1__["createCMAHttpClient"])(params);
    client = Object(_create_contentful_api__WEBPACK_IMPORTED_MODULE_0__["default"])({
      http: http
    });
  }
...
/*!***********************************!*\
  !*** ./create-cma-http-client.ts ***!
  \***********************************/
/*! exports provided: defaultHostParameters, createCMAHttpClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function createCMAHttpClient(params) {
  ...
  params = _objectSpread(_objectSpread({}, defaultHostParameters), fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(params));
...
/* harmony import */ var _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./plain/endpoints */ "./plain/endpoints/index.ts");
...
function createClientApi(_ref) {
  ...
  var _entities$organizatio = _entities__WEBPACK_IMPORTED_MODULE_2__["default"].organization,
  ...
  return {
    ...
    getSpaces: function getSpaces() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["space"].getMany(http, {
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
      }).then(function (data) {
        return wrapSpaceCollection(http, data);
      });
    },
    ...
    getSpace: function getSpace(spaceId) {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["space"].get(http, {
        spaceId: spaceId
      }).then(function (data) {
    ...
    createSpace: function createSpace(spaceData, organizationId) {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["space"].create(http, {
        organizationId: organizationId
      }, spaceData).then(function (data) {
        return wrapSpace(http, data);
      });
    },
    ...
    getOrganization: function getOrganization(id) {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["organization"].get(http, {
        organizationId: id
      }).then(function (data) {
    ...
    getOrganizations: function getOrganizations() {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["organization"].getAll(http).then(function (data) {
        return wrapOrganizationCollection(http, data);
      });
    },
    ...
    createPersonalAccessToken: function createPersonalAccessToken(data) {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["personalAccessToken"].create(http, data).then(function (response) {
        return wrapPersonalAccessToken(http, response);
      });
    },
    ...
    getPersonalAccessToken: function getPersonalAccessToken(tokenId) {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["personalAccessToken"].get(http, {
        tokenId: tokenId
      }).then(function (data) {
    ...
    getPersonalAccessTokens: function getPersonalAccessTokens() {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["personalAccessToken"].getMany(http, {}).then(function (data) {
        return wrapPersonalAccessTokenCollection(http, data);
      });
    },
    ...
    getOrganizationUsage: function getOrganizationUsage(organizationId) {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["usage"].getManyForOrganization(http, {
        organizationId: organizationId,
        query: query
      }).then(function (data) {
        return wrapUsageCollection(http, data);
      });
    },
    ...
    getSpaceUsage: function getSpaceUsage(organizationId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["usage"].getManyForSpace(http, {
        organizationId: organizationId,
        query: query
      }).then(function (data) {
        return wrapUsageCollection(http, data);
...
/* harmony import */ var _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plain/endpoints */ "./plain/endpoints/index.ts");
...
function createEnvironmentApi(_ref) {
  ...
  var _entities$uiExtension = _entities__WEBPACK_IMPORTED_MODULE_1__["default"].uiExtension,
  ...
  return {
    ...
    delete: function deleteEnvironment() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environment"].del(http, {
    ...
    update: function updateEnvironment() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environment"].update(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
    ...
    getContentType: function getContentType(contentTypeId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["contentType"].get(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
    ...
    getContentTypes: function getContentTypes() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["contentType"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
    ...
    createContentType: function createContentType(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["contentType"].create(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
    ...
    createContentTypeWithId: function createContentTypeWithId(contentTypeId, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["contentType"].createWithId(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        contentTypeId: contentTypeId
      }, data).then(function (data) {
    ...
    getEditorInterfaceForContentType: function getEditorInterfaceForContentType(contentTypeId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["editorInterface"].get(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        contentTypeId: contentTypeId
    ...
    getEditorInterfaces: function getEditorInterfaces() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["editorInterface"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }).then(function (response) {
    ...
    getEntry: function getEntry(id) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["entry"].get(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        entryId: id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
    ...
    getEntries: function getEntries() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["entry"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
    ...
    createEntry: function createEntry(contentTypeId, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["entry"].create(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        contentTypeId: contentTypeId
      }, data).then(function (data) {
    ...
    createEntryWithId: function createEntryWithId(contentTypeId, id, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["entry"].createWithId(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        entryId: id,
        contentTypeId: contentTypeId
    ...
    getAsset: function getAsset(id) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["asset"].get(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        assetId: id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
    ...
    getAssets: function getAssets() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["asset"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
    ...
    createAsset: function createAsset(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["asset"].create(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }, data).then(function (data) {
        return wrapAsset(http, data);
    ...
    createAssetWithId: function createAssetWithId(id, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["asset"].createWithId(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        assetId: id
      }, data).then(function (data) {
    ...
    createAssetFromFiles: function createAssetFromFiles(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["asset"].createFromFiles(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }, data).then(function (data) {
        return wrapAsset(http, data);
    ...
    getUpload: function getUpload(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["upload"].get(http, {
        spaceId: raw.sys.space.sys.id,
        uploadId: id
      }).then(function (data) {
    ...
    createUpload: function createUpload(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["upload"].create(http, {
        spaceId: raw.sys.space.sys.id
      }, data).then(function (data) {
        return wrapUpload(http, data);
      });
    ...
    getLocale: function getLocale(localeId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["locale"].get(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        localeId: localeId
      }).then(function (data) {
    ...
    getLocales: function getLocales() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["locale"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }).then(function (data) {
    ...
    createLocale: function createLocale(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["locale"].create(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }, data).then(function (data) {
        return wrapLocale(http, data);
    ...
    getUiExtension: function getUiExtension(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["uiExtension"].get(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        extensionId: id
      }).then(function (data) {
    ...
    getUiExtensions: function getUiExtensions() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["uiExtension"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }).then(function (data) {
    ...
    createUiExtension: function createUiExtension(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["uiExtension"].create(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }, data).then(function (data) {
        return wrapUiExtension(http, data);
    ...
    createUiExtensionWithId: function createUiExtensionWithId(id, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["uiExtension"].createWithId(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        extensionId: id
      }, data).then(function (data) {
    ...
    createAppInstallation: function createAppInstallation(appDefinitionId, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["appInstallation"].upsert(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
    ...
    getAppInstallation: function getAppInstallation(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["appInstallation"].get(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        appDefinitionId: id
      }).then(function (data) {
    ...
    getAppInstallations: function getAppInstallations() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["appInstallation"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }).then(function (data) {
    ...
    getEntrySnapshots: function getEntrySnapshots(entryId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["snapshot"].getManyForEntry(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        entryId: entryId,
        query: query
    ...
    getContentTypeSnapshots: function getContentTypeSnapshots(contentTypeId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["snapshot"].getManyForContentType(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        contentTypeId: contentTypeId,
        query: query
    ...
    getTags: function getTags() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["tag"].getMany(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        ...
        return Object(_entities_tag__WEBPACK_IMPORTED_MODULE_3__["wrapTagCollection"])(http, data);
      });
    },
    getTag: function getTag(id) {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["tag"].get(http, params).then(function (data) {
        return Object(_entities_tag__WEBPACK_IMPORTED_MODULE_3__["wrapTag"])(http, data);
      });
    }
  };
 ...
 */
function createOrganizationApi(_ref) {
  var http = _ref.http;
  ...
  return {
    ...
    getUser: function getUser(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["user"].getForOrganization(http, {
    ...
    getUsers: function getUsers() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["user"].getManyForOrganization(http, {
        organizationId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
      }).then(function (data) {
        return wrapUserCollection(http, data);
      });
    },
    ...
    getOrganizationMembership: function getOrganizationMembership(id) {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["organizationMembership"].get(http, {
        organizationId: organizationId,
    ...
    getOrganizationMemberships: function getOrganizationMemberships() {
      ...
      var raw = this.toPlainObject();
      var organizationId = raw.sys.id;
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["organizationMembership"].getMany(http, {
        organizationId: organizationId,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
      }).then(function (data) {
        return wrapOrganizationMembershipCollection(http, data, organizationId);
      });
    },
    ...
    createTeam: function createTeam(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["team"].create(http, {
        organizationId: raw.sys.id
      }, data).then(function (data) {
    ...
    getTeam: function getTeam(teamId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["team"].get(http, {
        organizationId: raw.sys.id,
        teamId: teamId
      }).then(function (data) {
        return wrapTeam(http, data);
    ...
    getTeams: function getTeams() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["team"].getMany(http, {
        organizationId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
      }).then(function (data) {
        return wrapTeamCollection(http, data);
      });
    },
    ...
    createTeamMembership: function createTeamMembership(teamId, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamMembership"].create(http, {
        organizationId: raw.sys.id,
        teamId: teamId
      }, data).then(function (data) {
    ...
    getTeamMembership: function getTeamMembership(teamId, teamMembershipId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamMembership"].get(http, {
        organizationId: raw.sys.id,
        teamId: teamId,
    ...
    getTeamMemberships: function getTeamMemberships() {
      ...
      if (teamId) {
        return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamMembership"].getManyForTeam(http, {
          organizationId: raw.sys.id,
          teamId: teamId,
          query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
            query: query
          ...
          return wrapTeamMembershipCollection(http, data);
        });
      }

      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamMembership"].getManyForOrganization(http, {
        organizationId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
    ...
    getTeamSpaceMemberships: function getTeamSpaceMemberships() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamSpaceMembership"].getManyForOrganization(http, {
        organizationId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: opts.query || {}
        }).params,
        ...
        return wrapTeamSpaceMembershipCollection(http, data);
      });
    },
    ...
    getTeamSpaceMembership: function getTeamSpaceMembership(teamSpaceMembershipId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamSpaceMembership"].getForOrganization(http, {
        organizationId: raw.sys.id,
    ...
    getOrganizationSpaceMembership: function getOrganizationSpaceMembership(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMembership"].getForOrganization(http, {
        organizationId: raw.sys.id,
    ...
    getOrganizationSpaceMemberships: function getOrganizationSpaceMemberships() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMembership"].getManyForOrganization(http, {
        organizationId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
      }).then(function (data) {
        return wrapSpaceMembershipCollection(http, data);
      });
    },
    ...
    getOrganizationInvitation: function getOrganizationInvitation(invitationId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["organizationInvitation"].get(http, {
        organizationId: raw.sys.id,
        invitationId: invitationId
      }).then(function (data) {
        return wrapOrganizationInvitation(http, data);
      });
    },
    ...
    createOrganizationInvitation: function createOrganizationInvitation(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["organizationInvitation"].create(http, {
        organizationId: raw.sys.id
      }, data).then(function (data) {
        return wrapOrganizationInvitation(http, data);
      });
    ...
    createAppDefinition: function createAppDefinition(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["appDefinition"].create(http, {
        organizationId: raw.sys.id
      }, data).then(function (data) {
    ...
    getAppDefinitions: function getAppDefinitions() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["appDefinition"].getMany(http, {
        organizationId: raw.sys.id,
        query: query
      }).then(function (data) {
        return wrapAppDefinitionCollection(http, data);
      });
    },
    ...
    getAppDefinition: function getAppDefinition(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["appDefinition"].get(http, {
        organizationId: raw.sys.id,
        appDefinitionId: id
      }).then(function (data) {
        return wrapAppDefinition(http, data);
...
function createSpaceApi(_ref) {
  ...
  return {
    ...
    delete: function deleteSpace() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["space"].del(http, {
        spaceId: raw.sys.id
      });
    },
    ...
    update: function updateSpace() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["space"].update(http, {
        spaceId: raw.sys.id
      }, raw).then(function (data) {
        return wrapSpace(http, data);
      });
    ...
    getEnvironment: function getEnvironment(environmentId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environment"].get(http, {
        spaceId: raw.sys.id,
    ...
    getEnvironments: function getEnvironments() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environment"].getMany(http, {
        spaceId: raw.sys.id,
        query: query
      }).then(function (data) {
        return wrapEnvironmentCollection(http, data);
      });
    },
    ...
    createEnvironment: function createEnvironment() {
      ...
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environment"].create(http, {
        spaceId: raw.sys.id
      }, data).then(function (response) {
        return wrapEnvironment(http, response);
      });
    },
    ...
    createEnvironmentWithId: function createEnvironmentWithId(id, data, sourceEnvironmentId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environment"].createWithId(http, {
        spaceId: raw.sys.id,
        environmentId: id,
    ...
    getWebhook: function getWebhook(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["webhook"].get(http, {
        spaceId: raw.sys.id,
        webhookDefinitionId: id
      }).then(function (data) {
        return wrapWebhook(http, data);
      });
    },
    ...
    getWebhooks: function getWebhooks() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["webhook"].getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
        return wrapWebhookCollection(http, data);
      });
    },
    ...
    createWebhook: function createWebhook(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["webhook"].create(http, {
        spaceId: raw.sys.id
      }, data).then(function (data) {
        return wrapWebhook(http, data);
      });
    ...
    createWebhookWithId: function createWebhookWithId(id, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["webhook"].createWithId(http, {
        spaceId: raw.sys.id,
        webhookDefinitionId: id
      }, data).then(function (data) {
        return wrapWebhook(http, data);
    ...
    getRole: function getRole(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["role"].get(http, {
        spaceId: raw.sys.id,
        roleId: id
      }).then(function (data) {
    ...
    getRoles: function getRoles() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["role"].getMany(http, {
        spaceId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
    ...
    createRole: function createRole(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["role"].create(http, {
        spaceId: raw.sys.id
      }, data).then(function (data) {
        return wrapRole(http, data);
      });
    ...
    createRoleWithId: function createRoleWithId(id, roleData) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["role"].createWithId(http, {
        spaceId: raw.sys.id,
        roleId: id
    ...
    getSpaceUser: function getSpaceUser(userId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["user"].getForSpace(http, {
        spaceId: raw.sys.id,
        userId: userId
      }).then(function (data) {
        return wrapUser(http, data);
    ...
    getSpaceUsers: function getSpaceUsers() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["user"].getManyForSpace(http, {
        spaceId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
    ...
    getSpaceMember: function getSpaceMember(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMember"].get(http, {
        spaceId: raw.sys.id,
        spaceMemberId: id
      }).then(function (data) {
        return wrapSpaceMember(http, data);
      });
    },
    ...
    getSpaceMembers: function getSpaceMembers() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMember"].getMany(http, {
        spaceId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
      }).then(function (data) {
        return wrapSpaceMemberCollection(http, data);
      });
    },
    ...
    getSpaceMembership: function getSpaceMembership(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMembership"].get(http, {
        spaceId: raw.sys.id,
        spaceMembershipId: id
      }).then(function (data) {
        return wrapSpaceMembership(http, data);
    ...
    getSpaceMemberships: function getSpaceMemberships() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMembership"].getMany(http, {
        spaceId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
    ...
    createSpaceMembership: function createSpaceMembership(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMembership"].create(http, {
        spaceId: raw.sys.id
      }, data).then(function (response) {
        return wrapSpaceMembership(http, response);
      });
    },
    ...
    createSpaceMembershipWithId: function createSpaceMembershipWithId(id, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["spaceMembership"].createWithId(http, {
        spaceId: raw.sys.id,
        spaceMembershipId: id
      }, data).then(function (response) {
        return wrapSpaceMembership(http, response);
    ...
    getTeamSpaceMembership: function getTeamSpaceMembership(teamSpaceMembershipId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamSpaceMembership"].get(http, {
        spaceId: raw.sys.id,
        teamSpaceMembershipId: teamSpaceMembershipId
      }).then(function (data) {
        return wrapTeamSpaceMembership(http, data);
    ...
    getTeamSpaceMemberships: function getTeamSpaceMemberships() {
      var query = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamSpaceMembership"].getMany(http, {
        spaceId: raw.sys.id,
        query: Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
          query: query
        }).params
    ...
    */
    createTeamSpaceMembership: function createTeamSpaceMembership(teamId, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["teamSpaceMembership"].create(http, {
        spaceId: raw.sys.id,
        teamId: teamId
      }, data).then(function (data) {
        return wrapTeamSpaceMembership(http, data);
    ...
    getApiKey: function getApiKey(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["apiKey"].get(http, {
        spaceId: raw.sys.id,
        apiKeyId: id
      }).then(function (data) {
    ...
    getApiKeys: function getApiKeys() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["apiKey"].getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
        return wrapApiKeyCollection(http, data);
      });
    },
    ...
    getPreviewApiKeys: function getPreviewApiKeys() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["previewApiKey"].getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
        return wrapPreviewApiKeyCollection(http, data);
      });
    },
    ...
    getPreviewApiKey: function getPreviewApiKey(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["previewApiKey"].get(http, {
        spaceId: raw.sys.id,
        previewApiKeyId: id
      }).then(function (data) {
        return wrapPreviewApiKey(http, data);
      });
    },
    ...
    createApiKey: function createApiKey(payload) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["apiKey"].create(http, {
        spaceId: raw.sys.id
    ...
    createApiKeyWithId: function createApiKeyWithId(id, payload) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["apiKey"].createWithId(http, {
        spaceId: raw.sys.id,
        apiKeyId: id
      }, payload).then(function (data) {
        return wrapApiKey(http, data);
    ...
    createEnvironmentAliasWithId: function createEnvironmentAliasWithId(environmentAliasId, data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environmentAlias"].createWithId(http, {
        spaceId: raw.sys.id,
    ...
    getEnvironmentAlias: function getEnvironmentAlias(environmentAliasId) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environmentAlias"].get(http, {
        spaceId: raw.sys.id,
        environmentAliasId: environmentAliasId
      }).then(function (data) {
        return wrapEnvironmentAlias(http, data);
    ...
    getEnvironmentAliases: function getEnvironmentAliases() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["environmentAlias"].getMany(http, {
        spaceId: raw.sys.id
      }).then(function (data) {
        return wrapEnvironmentAliasCollection(http, data);
      });
    },
    ...
    getScheduledActions: function getScheduledActions(query) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["scheduledAction"].getMany(http, {
        spaceId: raw.sys.id,
        query: query
      }).then(function (response) {
        return wrapScheduledActionCollection(http, response);
      });
    },
    ...
    createScheduledAction: function createScheduledAction(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["scheduledAction"].create(http, {
        spaceId: raw.sys.id
      }, data).then(function (response) {
        return wrapScheduledAction(http, response);
      });
    }
  };
}
...
/* harmony import */ var _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../plain/endpoints */ "./plain/endpoints/index.ts");
...
function createApiKeyApi(http) {
  ...
  return {
    update: function update() {
      var self = this;
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["apiKey"].update(http, getParams(self), self).then(function (data) {
        return wrapApiKey(http, data);
      });
    },
    delete: function del() {
      var self = this;
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["apiKey"].del(http, getParams(self));
    }
  };
}
/**
...
function wrapApiKey(http, data) {
  var apiKey = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var apiKeyWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(apiKey, createApiKeyApi(http));
...
var wrapApiKeyCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_3__["wrapCollection"])(wrapApiKey);
...
function createAppDefinitionApi(http) {
  ...
  return {
    update: function update() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["appDefinition"].update(http, getParams(data), data).then(function (data) {
        return wrapAppDefinition(http, data);
      });
    },
    delete: function del() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["appDefinition"].del(http, getParams(data));
    }
  };
}
/**
...
function wrapAppDefinition(http, data) {
  ...
  var appDefinitionWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(appDefinition, createAppDefinitionApi(http));
...
function createAppInstallationApi(http) {
  ...
  return {
    update: function update() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["appInstallation"].upsert(http, getParams(data), data).then(function (data) {
        return wrapAppInstallation(http, data);
      });
    },
    delete: function del() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["appInstallation"].del(http, getParams(data));
    }
  };
}
/**
...
function wrapAppInstallation(http, data) {
  ...
  var appInstallationWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(appInstallation, createAppInstallationApi(http));
...
function createAssetApi(http) {
  ...
  return {
    processForLocale: function processForLocale(locale, options) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].processForLocale(http, getParams(raw), raw, locale, options).then(function (data) {
        return wrapAsset(http, data);
      });
    },
    processForAllLocales: function processForAllLocales(options) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].processForAllLocales(http, getParams(raw), raw, options).then(function (data) {
        return wrapAsset(http, data);
      });
    },
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].update(http, getParams(raw), raw).then(function (data) {
        return wrapAsset(http, data);
      });
    },
    delete: function del() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].del(http, getParams(raw));
    },
    publish: function publish() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].publish(http, getParams(raw), raw).then(function (data) {
        return wrapAsset(http, data);
      });
    },
    unpublish: function unpublish() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].unpublish(http, getParams(raw)).then(function (data) {
        return wrapAsset(http, data);
      });
    },
    archive: function archive() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].archive(http, getParams(raw)).then(function (data) {
        return wrapAsset(http, data);
      });
    },
    unarchive: function unarchive() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["asset"].unarchive(http, getParams(raw)).then(function (data) {
        return wrapAsset(http, data);
      });
    },
...
function wrapAsset(http, data) {
  ...
  var assetWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(asset, createAssetApi(http));
...
/* harmony import */ var _enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../enhance-with-methods */ "./enhance-with-methods.ts");
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common-utils */ "./common-utils.ts");
/* harmony import */ var _editor_interface__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor-interface */ "./entities/editor-interface.ts");
/* harmony import */ var _snapshot__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./snapshot */ "./entities/snapshot.ts");
/* harmony import */ var _plain_checks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../plain/checks */ "./plain/checks.ts");
/* harmony import */ var _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../plain/endpoints */ "./plain/endpoints/index.ts");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
function createContentTypeApi(http) {
  ...
  return {
    update: function update() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["contentType"].update(http, params, raw).then(function (data) {
        return wrapContentType(http, data);
      });
    },
    delete: function _delete() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["contentType"].del(http, params).then(function () {// noop
      });
    },
    publish: function publish() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["contentType"].publish(http, params, raw).then(function (data) {
        return wrapContentType(http, data);
      });
    },
    unpublish: function unpublish() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["contentType"].unpublish(http, params).then(function (data) {
        return wrapContentType(http, data);
      });
    },
    getEditorInterface: function getEditorInterface() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["editorInterface"].get(http, params).then(function (data) {
        return Object(_editor_interface__WEBPACK_IMPORTED_MODULE_4__["wrapEditorInterface"])(http, data);
      });
    },
    getSnapshots: function getSnapshots() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["snapshot"].getManyForContentType(http, _objectSpread(_objectSpread({}, params), {}, {
        query: query
      })).then(function (data) {
        return Object(_snapshot__WEBPACK_IMPORTED_MODULE_5__["wrapSnapshotCollection"])(http, data);
      });
    },
    getSnapshot: function getSnapshot(snapshotId) {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["snapshot"].getForContentType(http, _objectSpread(_objectSpread({}, params), {}, {
        snapshotId: snapshotId
      })).then(function (data) {
        return Object(_snapshot__WEBPACK_IMPORTED_MODULE_5__["wrapSnapshot"])(http, data);
      });
    },
    isPublished: function isPublished() {
      return Object(_plain_checks__WEBPACK_IMPORTED_MODULE_6__["isPublished"])(this);
    },
    isUpdated: function isUpdated() {
      return Object(_plain_checks__WEBPACK_IMPORTED_MODULE_6__["isUpdated"])(this);
    },
    isDraft: function isDraft() {
      return Object(_plain_checks__WEBPACK_IMPORTED_MODULE_6__["isDraft"])(this);
    },
    omitAndDeleteField: function omitAndDeleteField(id) {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_7__["contentType"].omitAndDeleteField(http, params, raw, id).then(function (data) {
        return wrapContentType(http, data);
      });
    }
  };
...
function wrapContentType(http, data) {
  var contentType = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var contentTypeWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(contentType, createContentTypeApi(http));
...
var wrapContentTypeCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_3__["wrapCollection"])(wrapContentType);
...
function createEditorInterfaceApi(http) {
  return {
    update: function update() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["editorInterface"].update(http, {
...
function wrapEditorInterface(http, data) {
  ...
  var editorInterfaceWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(editorInterface, createEditorInterfaceApi(http));
...
/* harmony import */ var _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../plain/endpoints */ "./plain/endpoints/index.ts");
/* harmony import */ var _plain_checks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../plain/checks */ "./plain/checks.ts");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
function createEntryApi(http) {
  ...
  return {
    update: function update() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["entry"].update(http, params, raw).then(function (data) {
        return wrapEntry(http, data);
      });
    },
    delete: function del() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["entry"].del(http, params);
    },
    publish: function publish() {
      var _getParams3 = getParams(this),
          raw = _getParams3.raw,
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["entry"].publish(http, params, raw).then(function (data) {
        return wrapEntry(http, data);
      });
    },
    unpublish: function unpublish() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["entry"].unpublish(http, params).then(function (data) {
        return wrapEntry(http, data);
      });
    },
    archive: function archive() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["entry"].archive(http, params).then(function (data) {
        return wrapEntry(http, data);
      });
    },
    unarchive: function unarchive() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["entry"].unarchive(http, params).then(function (data) {
        return wrapEntry(http, data);
      });
    },
    getSnapshots: function getSnapshots() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["snapshot"].getManyForEntry(http, _objectSpread(_objectSpread({}, params), {}, {
        query: query
      })).then(function (data) {
        return Object(_snapshot__WEBPACK_IMPORTED_MODULE_4__["wrapSnapshotCollection"])(http, data);
      });
    },
    getSnapshot: function getSnapshot(snapshotId) {
      var _getParams8 = getParams(this),
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_5__["snapshot"].getForEntry(http, _objectSpread(_objectSpread({}, params), {}, {
        snapshotId: snapshotId
      })).then(function (data) {
        return Object(_snapshot__WEBPACK_IMPORTED_MODULE_4__["wrapSnapshot"])(http, data);
      });
    },
    isPublished: function isPublished() {
      var raw = this.toPlainObject();
      return _plain_checks__WEBPACK_IMPORTED_MODULE_6__["isPublished"](raw);
    },
    isUpdated: function isUpdated() {
      var raw = this.toPlainObject();
      return _plain_checks__WEBPACK_IMPORTED_MODULE_6__["isUpdated"](raw);
    },
    isDraft: function isDraft() {
      var raw = this.toPlainObject();
      return _plain_checks__WEBPACK_IMPORTED_MODULE_6__["isDraft"](raw);
    },
    isArchived: function isArchived() {
      var raw = this.toPlainObject();
      return _plain_checks__WEBPACK_IMPORTED_MODULE_6__["isArchived"](raw);
    }
  };
}
/**
...
function wrapEntry(http, data) {
  ...
  var entryWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(entry, createEntryApi(http));
...
function createEnvironmentAliasApi(http) {
  ...
  return {
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["environmentAlias"].update(http, getParams(raw), raw).then(function (data) {
        return wrapEnvironmentAlias(http, data);
      });
    },
    delete: function _delete() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["environmentAlias"].del(http, getParams(raw)).then(function () {// noop
      });
    }
  };
}
...
function wrapEnvironmentAlias(http, data) {
  ...
  var enhancedAlias = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(alias, createEnvironmentAliasApi(http));
...
function createLocaleApi(http) {
  ...
  return {
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["locale"].update(http, getParams(raw), raw).then(function (data) {
        return wrapLocale(http, data);
      });
    },
    delete: function _delete() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["locale"].del(http, getParams(raw)).then(function () {// noop
      });
    }
  };
}
...
function wrapLocale(http, data) {
  ...
  var localeWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(locale, createLocaleApi(http));
 ...
 */
function wrapOrganizationInvitation(_http, data) {
  var invitation = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
function createOrganizationMembershipApi(http, organizationId) {
  ...
  return {
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["organizationMembership"].update(http, getParams(raw), raw).then(function (data) {
        return wrapOrganizationMembership(http, data, organizationId);
      });
    },
    delete: function del() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["organizationMembership"].del(http, getParams(raw));
    }
  };
}
/**
...
function wrapOrganizationMembership(http, data, organizationId) {
  ...
  var organizationMembershipWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(organizationMembership, createOrganizationMembershipApi(http, organizationId));
...
function wrapOrganization(http, data) {
  ...
  var orgApi = Object(_create_organization_api__WEBPACK_IMPORTED_MODULE_3__["default"])({
    http: http
  });
...
function wrapPersonalAccessToken(http, data) {
  ...
  var personalAccessTokenWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(personalAccessToken, {
    revoke: function revoke() {
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["personalAccessToken"].revoke(http, {
        tokenId: data.sys.id
      }).then(function (data) {
        return wrapPersonalAccessToken(http, data);
      });
...
function wrapPreviewApiKey(_http, data) {
  var previewApiKey = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var previewApiKeyWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(previewApiKey, createPreviewApiKeyApi());
...
var wrapPreviewApiKeyCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_3__["wrapCollection"])(wrapPreviewApiKey);
...
function createRoleApi(http) {
  ...
  return {
    update: function update() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["role"].update(http, getParams(data), data).then(function (data) {
        return wrapRole(http, data);
      });
    },
    delete: function del() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["role"].del(http, getParams(data));
    }
  };
}
/**
...
function wrapRole(http, data) {
  ...
  var roleWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(role, createRoleApi(http));
...
function createDeleteScheduledAction(http) {
  return function () {
    var data = this.toPlainObject();
    return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["scheduledAction"].del(http, {
      spaceId: data.sys.space.sys.id,
...
function createScheduledActionApi(http) {
  return {
    delete: createDeleteScheduledAction(http)
  };
}
function wrapScheduledAction(http, data) {
  ...
  var scheduledActionWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_3__["default"])(scheduledAction, createScheduledActionApi(http));
...
function wrapSpaceMember(http, data) {
  var spaceMember = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
...
function createSpaceMembershipApi(http) {
  ...
  return {
    update: function update() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["spaceMembership"].update(http, getParams(data), data).then(function (data) {
        return wrapSpaceMembership(http, data);
      });
    },
    delete: function del() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["spaceMembership"].del(http, getParams(data));
    }
  };
}
/**
...
function wrapSpaceMembership(http, data) {
  ...
  var spaceMembershipWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(spaceMembership, createSpaceMembershipApi(http));
...
function wrapSpace(http, data) {
  var space = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var spaceApi = Object(_create_space_api__WEBPACK_IMPORTED_MODULE_4__["default"])({
    http: http
  });
...
var wrapSpaceCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_3__["wrapCollection"])(wrapSpace);
...
function createTagApi(http) {
  ...
  return {
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["tag"].update(http, getParams(raw), raw).then(function (data) {
        return wrapTag(http, data);
      });
    },
    delete: function _delete() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["tag"].del(http, getParams(raw), raw.sys.version).then(function () {// noop
      });
    }
  };
}
function wrapTag(http, data) {
  ...
  var tagWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_3__["default"])(tag, createTagApi(http));
...
function createTeamMembershipApi(http) {
  ...
  return {
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["teamMembership"].update(http, getParams(raw), raw).then(function (data) {
        return wrapTeamMembership(http, data);
      });
    },
    delete: function del() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["teamMembership"].del(http, getParams(raw));
    }
  };
}
/**
...
function wrapTeamMembership(http, data) {
  ...
  var teamMembershipWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(teamMembership, createTeamMembershipApi(http));
...
function createTeamSpaceMembershipApi(http) {
  ...
  return {
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["teamSpaceMembership"].update(http, getParams(raw), raw).then(function (data) {
        return wrapTeamSpaceMembership(http, data);
      });
    },
    delete: function del() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["teamSpaceMembership"].del(http, getParams(data));
    }
  };
}
/**
...
function wrapTeamSpaceMembership(http, data) {
  ...
  var teamSpaceMembershipWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(teamSpaceMembership, createTeamSpaceMembershipApi(http));
...
function createTeamApi(http) {
  ...
  return {
    update: function update() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["team"].update(http, getParams(raw), raw).then(function (data) {
        return wrapTeam(http, data);
      });
    },
    delete: function del() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_4__["team"].del(http, getParams(raw));
    }
  };
}
/**
...
function wrapTeam(http, data) {
  ...
  var teamWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(team, createTeamApi(http));
...
function createUiExtensionApi(http) {
  ...
  return {
    update: function update() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["uiExtension"].update(http, getParams(data), data).then(function (data) {
        return wrapUiExtension(http, data);
      });
    },
    delete: function del() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["uiExtension"].del(http, getParams(data));
    }
  };
}
/**
...
function wrapUiExtension(http, data) {
  var uiExtension = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var uiExtensionWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(uiExtension, createUiExtensionApi(http));
...
var wrapUiExtensionCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapUiExtension);
...
function createUploadApi(http) {
  return {
    delete: function del() {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["upload"].del(http, {
        spaceId: raw.sys.space.sys.id,
        uploadId: raw.sys.id
      });
    }
...
function wrapUpload(http, data) {
  ...
  var uploadWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(upload, createUploadApi(http));
...
function wrapUsage(http, data) {
  var usage = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var usageWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(usage, {});
...
var wrapUsageCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_3__["wrapCollection"])(wrapUsage);
...
function createWebhookApi(http) {
  ...
  return {
    update: function update() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["webhook"].update(http, getParams(data), data).then(function (data) {
        return wrapWebhook(http, data);
      });
    },
    delete: function del() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["webhook"].del(http, getParams(data));
    },
    getCalls: function getCalls() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["webhook"].getManyCallDetails(http, getParams(data));
    },
    getCall: function getCall(id) {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["webhook"].getCallDetails(http, _objectSpread(_objectSpread({}, getParams(data)), {}, {
        callId: id
      }));
    },
    getHealth: function getHealth() {
      var data = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["webhook"].getHealthStatus(http, getParams(data));
    }
  };
}
/**
...
function wrapWebhook(http, data) {
  var webhook = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(fast_copy__WEBPACK_IMPORTED_MODULE_0___default()(data));
  var webhookWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(webhook, createWebhookApi(http));
...
var wrapWebhookCollection = Object(_common_utils__WEBPACK_IMPORTED_MODULE_4__["wrapCollection"])(wrapWebhook);
...
/***/ "./plain/endpoints/app-definition.ts":
/*!*******************************************!*\
  !*** ./plain/endpoints/app-definition.ts ***!
  \*******************************************/
...
/* harmony import */ var fast_copy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! fast-copy */ "../node_modules/fast-copy/dist/fast-copy.js");
/* harmony import */ var fast_copy__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(fast_copy__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./plain/endpoints/utils.ts");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(http, params, rawData, headers) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = fast_copy__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
            delete data.sys;
            return _context.abrupt("return", _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getAppDefinitionUrl(params), data, {
              headers: _objectSpread({
                'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
              }, headers)
            }));
...
/***/ "./plain/endpoints/app-installation.ts":
/*!*********************************************!*\
  !*** ./plain/endpoints/app-installation.ts ***!
  \*********************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "del", function() { return del; });
/* harmony import */ var _raw__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./raw */ "./plain/endpoints/raw.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./plain/endpoints/utils.ts");
/* harmony import */ var fast_copy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! fast-copy */ "../node_modules/fast-copy/dist/fast-copy.js");
/* harmony import */ var fast_copy__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(fast_copy__WEBPACK_IMPORTED_MODULE_2__);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/* harmony import */ var _upload__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./upload */ "./plain/endpoints/upload.ts");
/* harmony import */ var _upload_http_client__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../upload-http-client */ "./upload-http-client.ts");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(params.assetId), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_2__["normalizeSelect"])(params.query)
  });
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets"), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_2__["normalizeSelect"])(params.query)
  });
};
var update = function update(http, params, rawData, headers) {
  ...
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_3___default()(rawData);
  delete data.sys;
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(params.assetId), data, {
    headers: _objectSpread({
      'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
    }, headers)
  });
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(params.assetId));
};
var publish = function publish(http, params, rawData) {
  var _rawData$sys$version2;

  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(params.assetId, "/published"), null, {
    headers: {
...
var unpublish = function unpublish(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(params.assetId, "/published"));
};
var archive = function archive(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(params.assetId, "/archived"));
};
var unarchive = function unarchive(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(params.assetId, "/archived"));
};
var create = function create(http, params, rawData) {
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_3___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets"), data);
};
...
var createFromFiles = function createFromFiles(http, params, data) {
  var httpUpload = Object(_upload_http_client__WEBPACK_IMPORTED_MODULE_5__["getUploadHttpClient"])(http);
...
function processForLocale(http, params, asset, locale) {
  var _ref3 = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {},
      processingCheckWait = _ref3.processingCheckWait,
      processingCheckRetries = _ref3.processingCheckRetries;

  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/assets/").concat(asset.sys.id, "/files/").concat(locale, "/process"), null, {
    headers: {
...
function processForAllLocales(http, params, asset) {
  ...
  var allProcessingLocales = locales.map(function (locale) {
    return processForLocale(http, params, asset, locale, options).then(function (result) {
...
/***/ "./plain/endpoints/content-type.ts":
/*!*****************************************!*\
  !*** ./plain/endpoints/content-type.ts ***!
  \*****************************************/
/*! exports provided: get, getMany, create, createWithId, update, del, publish, unpublish, omitAndDeleteField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var createWithId = function createWithId(http, params, rawData) {
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getContentTypeUrl(params), data);
};
var update = function update(http, params, rawData, headers) {
  var _rawData$sys$version;
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, getContentTypeUrl(params));
};
var publish = function publish(http, params, rawData) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getContentTypeUrl(params) + '/published', null, {
    headers: {
...
var unpublish = function unpublish(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, getContentTypeUrl(params) + '/published');
};
...
var omitAndDeleteField = function omitAndDeleteField(http, params, contentType, fieldId) {
...
/***/ "./plain/endpoints/editor-interface.ts":
/*!*********************************************!*\
  !*** ./plain/endpoints/editor-interface.ts ***!
  \*********************************************/
...
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/editor_interfaces"));
};
var update = function update(http, params, rawData, headers) {
  var _rawData$sys$version;
  ...
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
  delete data.sys;
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getBaseUrl(params), data, {
    headers: _objectSpread({
      'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
    }, headers)
  });
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries/").concat(params.entryId), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["normalizeSelect"])(params.query)
  });
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries"), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["normalizeSelect"])(params.query)
  });
};
var update = function update(http, params, rawData, headers) {
  ...
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
  delete data.sys;
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries/").concat(params.entryId), data, {
    headers: _objectSpread({
      'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
    }, headers)
  });
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries/").concat(params.entryId));
};
var publish = function publish(http, params, rawData) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries/").concat(params.entryId, "/published"), null, {
    headers: {
      'X-Contentful-Version': rawData.sys.version
    }
  });
...
var unpublish = function unpublish(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries/").concat(params.entryId, "/published"));
};
var archive = function archive(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries/").concat(params.entryId, "/archived"));
};
var unarchive = function unarchive(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries/").concat(params.entryId, "/archived"));
};
var create = function create(http, params, rawData) {
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/entries"), data, {
    headers: {
...
/***/ "./plain/endpoints/environment-alias.ts":
/*!**********************************************!*\
  !*** ./plain/endpoints/environment-alias.ts ***!
  \**********************************************/
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getEnvironmentAliasUrl(params));
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getBaseUrl(params), {
    params: params.query
...
var createWithId = function createWithId(http, params, rawData, headers) {
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getEnvironmentAliasUrl(params), data, {
    headers: headers
  });
};
var update = function update(http, params, rawData, headers) {
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, getEnvironmentAliasUrl(params));
};

/***/ }),

/***/ "./plain/endpoints/environment.ts":
/*!****************************************!*\
  !*** ./plain/endpoints/environment.ts ***!
  \****************************************/
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId));
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments"), {
    params: params.query
  });
};
var update = function update(http, params, rawData, headers) {
  ...
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
  delete data.sys;
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId), data, {
    headers: _objectSpread(_objectSpread({}, headers), {}, {
      'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
    })
  });
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId));
};
var create = function create(http, params, rawData, headers) {
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, "/spaces/".concat(params.spaceId, "/environments"), data, {
    headers: headers
  });
};
var createWithId = function createWithId(http, params, rawData, headers) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _content_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./content-type */ "./plain/endpoints/content-type.ts");
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "contentType", function() { return _content_type__WEBPACK_IMPORTED_MODULE_0__; });
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./entry */ "./plain/endpoints/entry.ts");
...
/* harmony import */ var fast_copy__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fast_copy__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./plain/endpoints/utils.ts");
/* harmony import */ var _raw__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./raw */ "./plain/endpoints/raw.ts");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_2__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/locales/").concat(params.localeId));
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_2__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/locales"), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["normalizeSelect"])(params.query)
  });
};
var create = function create(http, params, data, headers) {
  return _raw__WEBPACK_IMPORTED_MODULE_2__["post"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/locales"), data, {
    headers: headers
  });
};
var update = function update(http, params, rawData, headers) {
  ...
  return _raw__WEBPACK_IMPORTED_MODULE_2__["put"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/locales/").concat(params.localeId), data, {
    headers: _objectSpread(_objectSpread({}, headers), {}, {
      'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
    })
  });
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_2__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/locales/").concat(params.localeId));
};

/***/ }),

/***/ "./plain/endpoints/organization-invitation.ts":
/*!****************************************************!*\
  !*** ./plain/endpoints/organization-invitation.ts ***!
  \****************************************************/
...
/***/ "./plain/endpoints/organization-membership.ts":
/*!****************************************************!*\
  !*** ./plain/endpoints/organization-membership.ts ***!
  \****************************************************/
...
var update = function update(http, params, rawData, headers) {
  ...
  delete data.sys;
  var role = data.role;
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getEntityUrl(params), {
    role: role
  }, {
    headers: _objectSpread(_objectSpread({}, headers), {}, {
      'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
...
/***/ "./plain/endpoints/organization.ts":
/*!*****************************************!*\
  !*** ./plain/endpoints/organization.ts ***!
  \*****************************************/
/*! exports provided: getAll, get */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getAll = function getAll(http) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/organizations");
};
var get = function get(http, params) {
  return getAll(http).then(function (data) {
...
/***/ "./plain/endpoints/personal-access-token.ts":
/*!**************************************************!*\
  !*** ./plain/endpoints/personal-access-token.ts ***!
  \**************************************************/
...
var create = function create(http, rawData, headers) {
...
/***/ "./plain/endpoints/preview-api-keys.ts":
/*!*********************************************!*\
  !*** ./plain/endpoints/preview-api-keys.ts ***!
  \*********************************************/
...
/* harmony import */ var fast_copy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fast-copy */ "../node_modules/fast-copy/dist/fast-copy.js");
/* harmony import */ var fast_copy__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fast_copy__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _raw__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./raw */ "./plain/endpoints/raw.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./plain/endpoints/utils.ts");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/***/ "./plain/endpoints/scheduled-action.ts":
/*!*********************************************!*\
  !*** ./plain/endpoints/scheduled-action.ts ***!
  \*********************************************/
...
/***/ "./plain/endpoints/space-member.ts":
/*!*****************************************!*\
  !*** ./plain/endpoints/space-member.ts ***!
  \*****************************************/
/*! exports provided: get, getMany */
...
/***/ "./plain/endpoints/space-membership.ts":
/*!*********************************************!*\
  !*** ./plain/endpoints/space-membership.ts ***!
  \*********************************************/
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId));
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces", {
    params: params.query
  });
};
var create = function create(http, params, rawData, headers) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, "/spaces", rawData, {
...
var update = function update(http, params, rawData, headers) {
  ...
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
  delete data.sys;
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, "/spaces/".concat(params.spaceId), data, {
    headers: _objectSpread({
      'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
    }, headers)
  });
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId));
};

/***/ }),

/***/ "./plain/endpoints/tag.ts":
/*!********************************!*\
  !*** ./plain/endpoints/tag.ts ***!
  \********************************/
/*! exports provided: get, getMany, createWithId, update, del */
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getTagUrl(params));
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getBaseUrl(params), {
    params: params.query
...
var del = function del(http, params, version) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, getTagUrl(params), {
    headers: {
...
/***/ "./plain/endpoints/team-membership.ts":
/*!********************************************!*\
  !*** ./plain/endpoints/team-membership.ts ***!
  \********************************************/
...
var getManyForOrganization = function getManyForOrganization(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/organizations/".concat(params.organizationId, "/team_memberships"), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_2__["normalizeSelect"])(params.query)
  });
};
...
var create = function create(http, params, rawData, headers) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, getBaseUrl(params), rawData, {
    headers: headers
  });
};
var update = function update(http, params, rawData, headers) {
...
/***/ "./plain/endpoints/team-space-membership.ts":
/*!**************************************************!*\
  !*** ./plain/endpoints/team-space-membership.ts ***!
  \**************************************************/
...
/***/ "./plain/endpoints/ui-extension.ts":
/*!*****************************************!*\
  !*** ./plain/endpoints/ui-extension.ts ***!
  \*****************************************/
/*! exports provided: getUIExtensionUrl, get, getMany, create, createWithId, update, del */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUIExtensionUrl", function() { return getUIExtensionUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "get", function() { return get; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMany", function() { return getMany; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "create", function() { return create; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createWithId", function() { return createWithId; });
...
var getUIExtensionUrl = function getUIExtensionUrl(params) {
  return getBaseUrl(params) + "/".concat(params.extensionId);
};
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getUIExtensionUrl(params), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["normalizeSelect"])(params.query)
  });
};
var getMany = function getMany(http, params) {
...
var createWithId = function createWithId(http, params, rawData, headers) {
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getUIExtensionUrl(params), data, {
    headers: headers
  });
};
var update = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(http, params, rawData, headers) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
            delete data.sys;
            return _context.abrupt("return", _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getUIExtensionUrl(params), data, {
              headers: _objectSpread({
                'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
              }, headers)
            }));
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, getUIExtensionUrl(params));
};

/***/ }),

/***/ "./plain/endpoints/upload.ts":
/*!***********************************!*\
  !*** ./plain/endpoints/upload.ts ***!
  \***********************************/
...
var create = function create(http, params, data) {
  ...
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](httpUpload, "/spaces/".concat(params.spaceId, "/uploads"), file, {
    headers: {
...
var del = function del(http, params) {
  var httpUpload = Object(_upload_http_client__WEBPACK_IMPORTED_MODULE_1__["getUploadHttpClient"])(http);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](httpUpload, "/spaces/".concat(params.spaceId, "/uploads/").concat(params.uploadId));
};
var get = function get(http, params) {
  var httpUpload = Object(_upload_http_client__WEBPACK_IMPORTED_MODULE_1__["getUploadHttpClient"])(http);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](httpUpload, "/spaces/".concat(params.spaceId, "/uploads/").concat(params.uploadId));
};

/***/ }),

/***/ "./plain/endpoints/usage.ts":
/*!**********************************!*\
  !*** ./plain/endpoints/usage.ts ***!
  \**********************************/
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getWebhookUrl(params));
};
var getManyCallDetails = function getManyCallDetails(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getWebhookCallUrl(params), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["normalizeSelect"])(params.query)
  });
};
var getCallDetails = function getCallDetails(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getWebhookCallDetailsUrl(params));
};
var getHealthStatus = function getHealthStatus(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getWebhookHealthUrl(params));
};
var getMany = function getMany(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, getBaseUrl(params), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_1__["normalizeSelect"])(params.query)
...
var createWithId = function createWithId(http, params, rawData, headers) {
  var data = fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getWebhookUrl(params), data, {
    headers: headers
  });
};
var update = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = fast_copy__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
            delete data.sys;
            return _context.abrupt("return", _raw__WEBPACK_IMPORTED_MODULE_0__["put"](http, getWebhookUrl(params), data, {
              headers: _objectSpread({
                'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
              }, headers)
            }));
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, getWebhookUrl(params));
};
...
/* harmony import */ var _create_cma_http_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../create-cma-http-client */ "./create-cma-http-client.ts");
/* harmony import */ var _endpoints__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./endpoints */ "./plain/endpoints/index.ts");
/* harmony import */ var _wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wrappers/wrap */ "./plain/wrappers/wrap.ts");



var createPlainClient = function createPlainClient(params, defaults) {
  var _http = Object(_create_cma_http_client__WEBPACK_IMPORTED_MODULE_0__["createCMAHttpClient"])(params, true);
  ...
  return {
    raw: {
      ...
      get: function (_get) {
        ...
        return (_endpoints$raw = _endpoints__WEBPACK_IMPORTED_MODULE_1__["raw"]).get.apply(_endpoints$raw, [_http].concat(args));
      }),
      post: function (_post) {
        function post() {
        ...
        return (_endpoints$raw2 = _endpoints__WEBPACK_IMPORTED_MODULE_1__["raw"]).post.apply(_endpoints$raw2, [_http].concat(args));
      }),
      put: function (_put) {
        function put() {
        ...
        return (_endpoints$raw3 = _endpoints__WEBPACK_IMPORTED_MODULE_1__["raw"]).put.apply(_endpoints$raw3, [_http].concat(args));
      }),
      delete: function _delete() {
        var _endpoints$raw4;
        ...
        return (_endpoints$raw4 = _endpoints__WEBPACK_IMPORTED_MODULE_1__["raw"]).del.apply(_endpoints$raw4, [_http].concat(args));
      },
      http: function http() {
        var _endpoints$raw5;
        ...
        return (_endpoints$raw5 = _endpoints__WEBPACK_IMPORTED_MODULE_1__["raw"]).http.apply(_endpoints$raw5, [_http].concat(args));
      }
    },
    editorInterface: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["editorInterface"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["editorInterface"].getMany),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["editorInterface"].update)
    },
    space: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["space"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["space"].getMany),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["space"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["space"].del),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["space"].create)
    },
    environment: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environment"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environment"].getMany),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environment"].create),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environment"].createWithId),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environment"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environment"].del)
    },
    environmentAlias: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environmentAlias"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environmentAlias"].getMany),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environmentAlias"].createWithId),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environmentAlias"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["environmentAlias"].del)
    },
    contentType: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["contentType"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["contentType"].getMany),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["contentType"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["contentType"].del),
      publish: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["contentType"].publish),
      unpublish: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["contentType"].unpublish),
      omitAndDeleteField: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["contentType"].omitAndDeleteField)
    },
    user: {
    ...
    entry: {
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].getMany),
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].get),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].del),
      publish: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].publish),
      unpublish: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].unpublish),
      archive: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].archive),
      unarchive: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].unarchive),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].create),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["entry"].createWithId)
    },
    asset: {
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].getMany),
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].get),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].del),
      publish: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].publish),
      unpublish: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].unpublish),
      archive: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].archive),
      unarchive: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].unarchive),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].create),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].createWithId),
      createFromFiles: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].createFromFiles),
    ...
    upload: {
      ...
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["upload"].del)
    },
    locale: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["locale"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["locale"].getMany),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["locale"].del),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["locale"].update),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["locale"].create)
    },
    personalAccessToken: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["personalAccessToken"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["personalAccessToken"].getMany),
      ...
      revoke: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["personalAccessToken"].revoke)
    },
    usage: {
      getManyForSpace: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["usage"].getManyForSpace),
      getManyForOrganization: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["usage"].getManyForOrganization)
    },
    role: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["role"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["role"].getMany),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["role"].create),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["role"].createWithId),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["role"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["role"].del)
    },
    scheduledActions: {
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["scheduledAction"].getMany),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["scheduledAction"].create),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["scheduledAction"].del)
    },
    previewApiKey: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["previewApiKey"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["previewApiKey"].getMany)
    },
    apiKey: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["apiKey"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["apiKey"].getMany),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["apiKey"].create),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["apiKey"].createWithId),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["apiKey"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["apiKey"].del)
    },
    appDefinition: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appDefinition"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appDefinition"].getMany),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appDefinition"].create),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appDefinition"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appDefinition"].del)
    },
    appInstallation: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appInstallation"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appInstallation"].getMany),
      upsert: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appInstallation"].upsert),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["appInstallation"].del)
    },
    extension: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["uiExtension"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["uiExtension"].getMany),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["uiExtension"].create),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["uiExtension"].createWithId),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["uiExtension"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["uiExtension"].del)
    },
    webhook: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].getMany),
      getHealthStatus: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].getHealthStatus),
      getCallDetails: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].getCallDetails),
      getManyCallDetails: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].getManyCallDetails),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].create),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["webhook"].del)
    },
    snapshot: {
      getManyForEntry: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["snapshot"].getManyForEntry),
      getForEntry: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["snapshot"].getForEntry),
      getManyForContentType: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["snapshot"].getManyForContentType),
      getForContentType: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["snapshot"].getForContentType)
    },
    tag: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["tag"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["tag"].getMany),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["tag"].createWithId),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["tag"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["tag"].del)
    },
    organization: {
      getAll: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrapHttp"])(_http, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organization"].getAll),
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organization"].get)
    },
    organizationInvitation: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organizationInvitation"].get),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organizationInvitation"].create)
    },
    organizationMembership: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organizationMembership"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organizationMembership"].getMany),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organizationMembership"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["organizationMembership"].del)
    },
    spaceMember: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMember"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMember"].getMany)
    },
    spaceMembership: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].getMany),
      getForOrganization: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].getForOrganization),
      getManyForOrganization: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].getManyForOrganization),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].create),
      createWithId: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].createWithId),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["spaceMembership"].del)
    },
    team: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["team"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["team"].getMany),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["team"].create),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["team"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["team"].del)
    },
    teamMembership: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamMembership"].get),
      getManyForOrganization: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamMembership"].getManyForOrganization),
      getManyForTeam: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamMembership"].getManyForTeam),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamMembership"].create),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamMembership"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamMembership"].del)
    },
    teamSpaceMembership: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamSpaceMembership"].get),
      getMany: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamSpaceMembership"].getMany),
      getForOrganization: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamSpaceMembership"].getForOrganization),
      getManyForOrganization: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamSpaceMembership"].getManyForOrganization),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamSpaceMembership"].create),
      update: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamSpaceMembership"].update),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["teamSpaceMembership"].del)
    }
  };
};
...
/*!********************************!*\
  !*** ./plain/wrappers/wrap.ts ***!
  \********************************/
/*! exports provided: wrap, wrapHttp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "wrap", function() { return wrap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "wrapHttp", function() { return wrapHttp; });
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/* eslint-disable @typescript-eslint/no-explicit-any */
var withHttp = function withHttp(http, fn) {
  return function (params) {
    for (var _len = arguments.length, rest = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      rest[_key - 1] = arguments[_key];
    }

    return fn.apply(void 0, [http, params].concat(rest));
  };
};

var withDefaults = function withDefaults(defaults, fn) {
  return function (params) {
    for (var _len2 = arguments.length, rest = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
      rest[_key2 - 1] = arguments[_key2];
    }

    return fn.apply(void 0, [_objectSpread(_objectSpread({}, defaults), params)].concat(rest));
  };
};

var wrap = function wrap(_ref, fn) {
  var http = _ref.http,
      defaults = _ref.defaults;
  return withDefaults(defaults, withHttp(http, fn));
};
var wrapHttp = function wrapHttp(http, fn) {
  return function () {
    return fn(http);
  };
};
